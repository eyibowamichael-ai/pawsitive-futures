    ...
    <footer className="mt-24 bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display text-xl">Mont Choisy</div>
              <div className="text-xs uppercase tracking-[0.25em] opacity-70">Animal Angels</div>
            </div>
          </div>
          <p className="mt-5 max-w-md text-sm leading-relaxed opacity-80">
            A community of volunteers giving stray and abandoned dogs and cats in
            Mauritius the second chance they deserve — through rescue, sterilisation,
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm opacity-80">
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 shrink-0" /> Mont Choisy, Mauritius</li>
            <li className="flex items-start gap-2"><Mail className="h-4 w-4 mt-0.5 shrink-0" /> hello@montchoisyangels.org</li>
            <li>
              <a href="https://www.facebook.com/share/1Nswsqm9CH/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 hover:opacity-100">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 py-6 text-xs opacity-60 flex flex-col sm:flex-row gap-2 justify-between">
          <span>© {new Date().getFullYear()} Mont Choisy Animal Angels. All rights reserved.</span>
